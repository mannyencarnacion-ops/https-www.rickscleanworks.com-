...
const ORIGIN = 'https://www.rickscleanworks.com';

const FORMS = {
  contact: {
    subject: "New lead from RicksCleanWorks.com",
    thankYou: '/thank-you',
    required: ['name', 'email', 'message'],
    autoSubject: "Thanks for contacting Rick's Clean Works",
    autoBody: (d) =>
      'Hi ' + d.name + ',\n\n' +
      "Thanks for reaching out to Rick's Clean Works. We got your request and we'll " +
      'get back to you with an estimate within one business day.\n\n' +
      'If it is urgent, call or text 978-394-6226.\n\n' +
      "- Rick's Clean Works\nrickscleanworks.com"
  }
};
...
function errorPage(msg, status, detail) {
  const html =
    ...
    '<p>Nothing reached us, so please email <a class="inline" href="mailto:ricklulimachi@rickscleanworks.com">' +
    'ricklulimachi@rickscleanworks.com</a> or call <strong>978-394-6226</strong> ' +
...
export async function onRequestPost(context) {
  ...
  try {
    ...
    const useResend = true; // client builds: Resend only, no fallback
